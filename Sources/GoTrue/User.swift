...
#if DEBUG
extension User {
    static let dummy = User(id: "", aud: "", role: "", email: "", emailConfirmedAt: nil, phone: "", confirmationSentAt: nil, confirmedAt: nil, lastSignInAt: nil, appMetadata: nil, userMetadata: nil, createdAt: Date(), updatedAt: Date())
}
#endif
